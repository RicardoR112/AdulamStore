...
public class ClienteController {
	...
	@GetMapping("/edit/{id}")
	public String editClient(HttpServletRequest request, HttpSession session, @PathVariable("id") Integer id,
	...
	@GetMapping("/list/{id}")
	public String listProductId(HttpServletRequest request, HttpSession session, @PathVariable("id") Integer id,
